...
| Research | [sota-research](sota-research.md) | Every Pheno\* repo owns a `docs/sota-<category>-YYYY.md` per major dep category; dated, code-level recommendation, decision matrix. |
