...
| Delegation | [parallel-execution](parallel-execution.md) | Worktree-per-subagent: N subagents → N worktrees → N `chore/<repo>-<purpose>-<date>` branches → atomic commits → single sponsor-merge pass. |
