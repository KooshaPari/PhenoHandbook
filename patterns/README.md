...
| Config | [config-loading](config-loading.md) | `phenotype_config_core::config_loader::load_config` for every typed config file; format auto-detect, 5 s read timeout, path-tagged `ConfigError`. |
